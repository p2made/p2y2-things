 ...
 *
 * use p2m\widgets\Dropdown;
 * ...
 * echo Dropdown::method([$params]);
 *
 * or
 *
 * echo \p2m\widgets\Dropdown::method([$params]);
 */
class Dropdown extends \yii\bootstrap5\Widget
{
	/**
