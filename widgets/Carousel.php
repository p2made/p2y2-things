 ...
 *
 * use p2m\widgets\Carousel;
 * ...
 * echo Carousel::method([$params]);
 *
 * or
 *
 * echo \p2m\widgets\Carousel::method([$params]);
 */
 ...
 */
class Carousel extends \yii\bootstrap5\Widget
{
	/**
