...
use p2m\assets\base\P2BootstrapAsset;

/**
 * Use this helper with...
 *
 * use p2m\demo\widgets\Nav;
 * ...
 * echo Nav::method([$params]);
 *
 * or
 *
 * echo \p2m\demo\widgets\Nav::method([$params]);
 */
 ...
 *
 */
class Nav extends \yii\bootstrap5\Widget
{
	/**
	...
	{
		//P2BootstrapAsset::register($this->getView());
