 ...
 *
 * use p2m\widgets\Progress;
 * ...
 * echo Progress::method([$params]);
 *
 * or
 *
 * echo \p2m\widgets\Progress::method([$params]);
 */
 ...
 */
class Progress extends \yii\bootstrap5\Widget
{
	/**
