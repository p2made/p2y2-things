...
use yii2fullcalendar\yii2fullcalendar as parentWidget;
...
class FontAwesomeWidget extends parentWidget
{
	/**
	...
	**/
	...
	/**
	* Registers the FullCalendar javascript assets and builds the
	* required js for the widget and the related events
	*/
	protected function registerPlugin()
	{
		...
		$assets = \p2made\assets\FullCalendarAsset::register($view);
