 ...
 * echo Uuid::uuid1();
 * echo Uuid::uuid3($subDomain = self::SUBDOMAIN_UUID);
 * echo Uuid::uuid4();
 * echo Uuid::uuid5($subDomain = self::SUBDOMAIN_UUID);
 *
 * or
 *
 * echo \p2m\helpers\Uuid::uuid($subDomain = self::SUBDOMAIN_DEFAULT);
 * echo \p2m\helpers\Uuid::uuid1();
 * echo \p2m\helpers\Uuid::uuid3($subDomain = self::SUBDOMAIN_UUID);
 * echo \p2m\helpers\Uuid::uuid4();
 * echo \p2m\helpers\Uuid::uuid5($subDomain = self::SUBDOMAIN_UUID);
 */
...
class Uuid
{
	...
	public static function uuid3($subDomain = self::SUBDOMAIN_UUID)
	{
	...
	public static function uuid5($subDomain = self::SUBDOMAIN_UUID)
	{
